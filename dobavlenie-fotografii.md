...
Первая фотография берется как превью для объявления. Если нужно сменить порядок или удалить фотографию, необходимо сначала удалить все фотографии отправив запрос на редактирование и указав photo\_count\[n\] = 0. А потом загрузить заново нужные фотографии, в нужном порядке. Фотографии добавляются по одному запросу на одно объявление.
