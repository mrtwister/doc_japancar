...
Ответ сервера может отличаться в зависимости от того каким образом были получены ссылки, там может быть текстовый ответ, xml или xml + json см [Получение адресов для работы с сервером.](/chapter1.md)
